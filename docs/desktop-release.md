...
`electron-updater` to check the GitHub Release feed when a packaged app starts.
...
published together for in-app updates to work.
...
and in-place installation after an update cannot be relied upon.
