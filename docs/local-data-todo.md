...
3. [ADR-0004](adr/0004-shared-durable-publish-and-partial-consumer-migration.md) 的局部 durable scope、[ADR-0005](adr/0005-main-owned-trace-correlation-and-safe-logs.md) 的 trace、[ADR-0006](adr/0006-scoped-memory-partition-and-readonly-migration-preflight.md) 的 readonly preflight，以及 [ADR-0024](adr/0024-memory-readonly-migration-dry-run-and-destructive-deferral.md) 的 dry-run intent/receipt，都不得被复用为 actionId、receipt、dedupe、transaction 或 destructive authorization。
