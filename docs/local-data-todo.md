...
| 需求 | 未满足的依赖/约束 |
| --- | --- |
| P5I exact retry | 产品/API/privacy 对 actionId、receipt、provider 与 recovery 的决定；不得复用 mission receipt（见 [ADR-0022](adr/0022-mission-update-action-receipt-correlation.md)）。 |
