...
- **关联：** [liveagent-worth-learning.md](../improvements/liveagent-worth-learning.md) §3.6；[ADR-0131](0131-pathname-default-durable-io.md)；`SECURITY.md`；`Agents.md` 产品地板（无开放 marketplace / 无 YOLO；**shell 产品面另立** ADR-0152/0153 + [delivery roadmap](../agent-shell-sandbox-delivery-roadmap.md)，本 ADR 安装路径 **不**引入 shell）
