...
| [ADR-0140](0140-mcp-marketplace-local-catalog.md) | MCP marketplace 本地目录 foundation（Phase H） | **已实施 foundation**；远程 catalog / install→connect 等体验开放见 [ADR-0141](0141-mcp-product-experience-parity-policy.md)。 |
| [ADR-0141](0141-mcp-product-experience-parity-policy.md) | MCP 产品体验对齐政策 | **已采纳**：放宽过度严格的体验边界（auto-connect、marketplace、install→connect、远程目录、McpSync 客户端等）；硬安全/settlement/secret 不变量保留。 |
