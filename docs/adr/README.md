...
| [ADR-0041](0041-context-hygiene-ladder-and-quality-gates.md) | Context hygiene ladder + quality gates | 默认 provider 投影阶梯（hygiene → compact）与可选 durable boundary；SECURITY.md、PR impact 门、workflow concurrency、check:prepush。 |
