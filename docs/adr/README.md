...
- 想知道接下来还准备做什么：阅读[本地数据待办](../local-data-todo.md)。其中的内容均为待批准或未实施工作，不应视为现有功能。
- 下一步工作必须遵循：待办页 → 对应 design gate 获得 scope / owner / API 批准 → 单独立项实施；design gate 本身不授权直接修改 writer。
- 想研究某项未实施工作的详细方案：从待办页进入 `docs/plans/` 中对应的 design gate。
...
| 哪些本地数据能力尚未实施 | [本地数据待办](../local-data-todo.md) |
...
- 已实施决定的范围、边界或验证入口变化时，更新对应 ADR；尚待批准的范围、前置条件和实施顺序变化时，更新[本地数据待办](../local-data-todo.md)及其 design gate。不要把后者的内容提前记为 ADR 已实施事实。
