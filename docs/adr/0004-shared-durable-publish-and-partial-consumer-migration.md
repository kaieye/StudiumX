...
- **状态：** 已实施（部分 consumer migration；包含 C-4P6-S1 的受限基础、C-4P8-S1/S2/S3 foundation、C-4P8-S4 受控 `write_workspace_file`，以及经明确批准的 Windows direct-path profile；并包含 C-4P9-S2 audit 专用 durable append 与 P9-S3 tests-only evidence）
