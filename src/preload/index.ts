...
const api: TeachingSystemApi = {
  ...
  readMindMapAsset: (payload) => ipcRenderer.invoke(teachingInvokeChannels.readMindMapAsset, payload),
  ...
  exportMindMapPortable: (payload) => ipcRenderer.invoke(teachingInvokeChannels.exportMindMapPortable, payload),
