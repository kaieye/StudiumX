/**
 * Local crash-marker main-process bootstrap status (B-11 / ADR-0007).
 *
 ...
 *
 * Residual after ADR-0007: rich Settings Doctor UI panel remains
 ...
 * common path/secret redaction now uses shared observability/redact (ADR-0007);
