...
const modelRowIndex = settingsView.indexOf("label={t('model.models.label')}")

assert.notEqual(modelRowIndex, -1)

const modelRowChunk = settingsView.slice(modelRowIndex, modelRowIndex + 1200)
...
assert.match(settingsView, /isCustomModelProvider \|\| !activeModelSettingsProvider\.docsUrl/)
assert.match(settingsView, /isCustomModelProvider \|\| !activeModelSettingsProvider\.apiKeyUrl/)
