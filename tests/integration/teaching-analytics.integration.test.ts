...
function settings(runtime: IsolatedTestRuntime): TeachingSettingsV1 {
  return {
    ...
    tools: { enabled: true, workspaceRead: true, approvalMode: 'ask', webSearch: false, webFetch: false, maxIterations: 3, runBudget: { maxDurationMs: 1000, maxProviderCalls: 2, maxToolCalls: 2, maxTotalTokens: 1000, warningThreshold: 0.8 } },
