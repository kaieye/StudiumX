...
- [ ] **Database-gates** — if touching `local-data-index` / projection / usage / database policy: filled [ADR-0053](docs/adr/0053-database-layered-authority-and-pr-gates.md) §2 gates; no unauthorized DB-P2-1…4 (§3); layered authority (§1)
